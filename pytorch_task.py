...
mod_parser.add_argument('--pos_weight', type=int, default=1,
                        help='a ratio adapted when ture sample was classified properly')
mod_parser.add_argument('--neg_weight', type=int, default=1,
...
dl_parse.add_argument('--if_pin_memory', type=bool, default=False)
dl_parse.add_argument('--num_work', type=int, default=0)
